...
CREATE TABLE Pais 
(
	PaisId UNIQUEIDENTIFIER NEWID() PRIMARY KEY,
...
CREATE TABLE Estado
(
	Estado UNIQUEIDENTIFIER NEWID() PRIMARI KEY,
...
CREATE TABLE Cidade 
(
	CidadeId UNIQUEIDENTIFIER NEWID() PRIMARI KEY,
...
(
	CargoId UNIQUEIDENTIFIER NEWID() PRIMARY KEY,
...
(
	StatusUsuarioId UNIQUEIDENTIFIER NEWID() PRIMARY KEY,
...
(
	UsuarioId UNIQUEIDENTIFIER NEWID() PRIMARY KEY,
	...
	CONSTRAINT FK_Usuario_SatatusUsuario_StatusId FOREIGN KEY (StatusUsuarioId) REFERENCES StatusUsuario(StatusId),
...
(
	EnderecoUsuarioId UNIQUEIDENTIFIER NEWID() PRIMARY KEY,
	...
	CONSTRAINT FK_EnderecoUsuario_Cidade_CidadeId FOREIGN KEY (CidadeId) REFERENCES Estado(CidadeId),
	CONSTRAINT FK_EnderecoUsuario_Pais_PaisId FOREIGN KEY (PaisId) REFERENCES Estado(PaisId)
);
GO

CREATE TABLE LogUsuario
(
	LogUsuarioId UNIQUEIDENTIFIER NEWID() PRIMARY KEY,
	UsuarioId UNIQUEIDENTIFIER NOT NULL,
	StatusUsuarioId UNIQUEIDENTIFIER NOT NULL,
	CargoUsuarioId UNIQUEIDENTIFIER NOT NULL,
	...
	CONSTRAINT FK_LogUsuario_StatusUsuario_StatusId FOREIGN KEY (StatusUsuarioId) REFERENCES StatusUsuario(StatusId),
...
(
	CarrinhoId UNIQUEIDENTIFIER NEWID() PRIMARY KEY,
...
(
	CategoriaId UNIQUEIDENTIFIER NEWID() PRIMARY KEY,
...
(
	StatusId UNIQUEIDENTIFIER NEWID() PRIMARY KEY,
...
(
	ProdutoId UNIQUEIDENTIFIER NEWID() PRIMARY KEY,
	...
	CONSTRAINT FK_Produto_StatusProduto_StatusId FOREIGN KEY (StausProdutoId) REFERENCES StatusProduto(StatusId),
	CONSTRAINT FK_Produto_CategoriaProduto_CategoriaId FOREIGN KEY (CategoriaProdutoId) REFERENCES Categoria(CategoriaId)
);
GO

CREATE TABLE EstoqueProduto
(
	UnidadeProdutoId UNIQUEIDENTIFIER NEWID() PRIMARY KEY,
	ProdutoId UNIQUEIDENTIFIER NOT NULL
...
(
	LogEstoqueProdutoId UNIQUEIDENTIFIER NEWID() PRIMARY KEY,
	UnidadeProdutoId UNIQUEIDENTIFIER NON NULL,
	ProdutoId UNIQUEIDENTIFIER NOT NULL,
	DescricaoLog NVARCHAR(100) NOT NULL,
	DataLog DATETIME2 DEFAULT GETDATE()
...
(
	StatusPedidoId UNIQUEIDENTIFIER NEWID() NOT NULL,
...
CREATE TABLE Pedido
(
	PedidoId UNIQUEIDENTIFIER NEWID() PRIMARY KEY,
	UsuarioId UNIQUEIDENTIFIER NOT NULL,
	EnderecoUsuarioId UNIQUEIDENTIFIER NOT NULL,
	...
	CONSTRAINT FK_Pedido_EnderecoUsuario_EnderecoUsuarioId FOREIGN KEY (EnderecoUsuarioId) REFERENCES EnderecoUsuairo(EnderecoId),
	CONSTRAINT FK_Pedido_StatusPedido_StatusPedidoId FOREIGN KEY (StatusPedidoId) REFERENCES EnderecoUsuairo(StatusPedidoId),
);
GO

CREATE TABLE LogPedido
(
	LogPedidoId UNIQUEIDENTIFIER NEWID() PRIMARY KEY,
	UsuarioId UNIQUEIDENTIFIER NOT NULL,
	EnderecoUsuarioId UNIQUEIDENTIFIER NOT NULL,
	StatusPedidoId UNIQUEIDENTIFIER NOT NULL,

	CONSTRAINT FK_LogPedido_Usuario_UsuarioId FOREIGN KEY (UsuarioId) REFERENCES Usuario(UsuarioId),
	CONSTRAINT FK_LogPedido_EnderecoUsuario_EnderecoUsuarioId FOREIGN KEY (EnderecoUsuarioId) REFERENCES EnderecoUsuairo(EnderecoId),
	CONSTRAINT FK_LogPedido_StatusPedido_StatusPedidoId FOREIGN KEY (StatusPedidoId) REFERENCES EnderecoUsuairo(StatusPedidoId),
);
GO
...
(
	StatusPagamentoId UNIQUEIDENTIFIER NEWID() PRIMARY KEY,
	NomeStatus VARCHAR(20)
);
GO
...
(
	PagamentoId UNIQUEIDENTIFIER NEWID() PRIMARY KEY,
	Valor DECIMAL(10, 2),
	PedidoId UNIQUEIDENTIFIER NOT NULL,
...
(
	LogPagamentoId UNIQUEIDENTIFIER NEWID() PRIMARY KEY,
	Valor DECIMAL(10, 2),
	PedidoId UNIQUEIDENTIFIER NOT NULL,
	StatusPagamentoId UNIQUEIDENTIFIER NOT NULL,
...
(
	StatusEntregaId UNIQUEIDENTIFIER NEWID() PRIMARY KEY,
	NomeStatus VARCHAR(20)
);
GO
...
(
	EntregaId UNIQUEIDENTIFIER NEWID() PRIMARY KEY,
	PedidoId UNIQUEIDENTIFIER NOT NULL,
...
(
	LogEntregaId UNIQUEIDENTIFIER NEWID() PRIMARY KEY,
